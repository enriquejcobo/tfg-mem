...
Freescale & MMA8453Q & 2g, 4g, 8g & $\hat{x}$, $\hat{y}$, $\hat{z}$ & Digital & 1.61 \euro & \cite{tmp36} \\ \hline
Analog Devices & ADXL345 & 2g, 4g, 8g, 16g & $\hat{x}$, $\hat{y}$, $\hat{z}$ & Digital & 0.24 \euro & \cite{mcp9701} \\ \hline
ST & LIS3DH & 2g, 4g, 8g & $\hat{x}$, $\hat{y}$, $\hat{z}$ & Digital & 1.07 \euro & \cite{lm20} \\ \hline
\end{tabular}
}
...
Murata & E710ST0 & Externa & [3 m, 6 m] & 8x8x8 & Analógica & 1.61 \euro & \cite{tmp36} \\ \hline
Panasonic & EKMC1601111 & Integrada & 3 m & 8x8x8 & Digital & 15.61 \euro & \cite{tmp36} \\ \hline
Panasonic & AMN33112J & Integrada & 3 m & 8x8x8 & Digital & 11.61 \euro & \cite{tmp36} \\ \hline
\end{tabular}
}
...
Everlight & ALS PT19 & 630 $\mu$m & 100 nA & Lineal & 0.76 \euro & \cite{tmp36} \\ \hline
Avago & APDS 9005 & 630 $\mu$m & 160 nA & Lineal & 0.44 \euro & \cite{tmp36} \\ \hline
Osram & SFH5711 & 630 $\mu$m & 100 nA & Logarítmica & 1.21 \euro & \cite{tmp36} \\ \hline
\end{tabular}
}
...
Al igual que en el caso anterior (\ref{previo:sec:buzzer}), este únicamente tiene como propósito actuar sobre el humano, siendo la principal diferencia que este modo de actuación se centra en dar información sobre el entorno o sobre el estado del sistema.
