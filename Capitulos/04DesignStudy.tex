...
A continuación, en la figura () se presentan los \textit{layouts} de nuestro diseño.



Para realizar el diseño de la \ac{PCB}, se han tenido en cuenta diversas consideraciones. En primer lugar, y como se puede apreciar, se ha construído bajo dos capas, suficiente para la colocación de los componentes, por lo que no ha sido necesario crear planos de alimentación, lo que hubiera aumentado, además, el coste de producción.
...
Adicionalmente, remarcamos la existencia de un plano de masa sobre ambas caras de la \ac{PCB}. Con esto conseguimos una reducción del ruido y de la influencia de emisiones electromagnéticas parásitas, puesto que este plano ofrece un camino de baja impedancia para estas corrientes.
...
PIR & \multicolumn{2}{c|}{-} & Panasonic AMN33112J & Radial & 1 \\ \hline
LUM & \multicolumn{2}{c|}{-} & Avago APDS 9005 & SMD & 1 \\ \hline \hline
IR & \multicolumn{2}{c|}{-} & Vishay TSUS 5202 & Radial & 1 \\ \hline
BUZZ & \multicolumn{2}{c|}{-} & TDK PS1720 & Radial & 1 \\ \hline
RED & \multicolumn{2}{c|}{-} & LED Rojo & 0805 & 1 \\ \hline
GREEN & \multicolumn{2}{c|}{-} & LED Verde & 0805 & 1 \\ \hline \hline
R1,2,11 & 4.7 & K$\Omega$ & Resistencia & 0805 & 3 \\ \hline
R3,13 & 10 & K$\Omega$ & Resistencia & 0805 & 2 \\ \hline
R6,7 & 330 & $\Omega$ & Resistencia & 0805 & 2 \\ \hline
R8 & 33 & $\Omega$ & Resistencia & 0805 & 1 \\ \hline
R9,10 & 1 & K$\Omega$ & Resistencia & 0805 & 2 \\ \hline
R12 & 200 & $\Omega$ & Resistencia & 0805 & 1 \\ \hline \hline
...
Q1 & \multicolumn{2}{c|}{-} & Transistor NPN & Axial & 1 \\ \hline
hd40 & \multicolumn{2}{c|}{-} & Header aplilable de 10 pines & Axial & 4 \\ \hline
\end{tabular}
}
...
Altium Designer ha sido el \textit{software} utilizado para los aspectos eléctricos de diseño, \ac{EDA}. Altium Designer es una aplicación diseñada para la creación de \ac{PCB}, FPGA, entre otras; desarrollada por Altium Limited.
...
\item \emph{Gestión de librerías de componentes}, tanto de los esquemas como de sus huellas. En este sentido, se han usado:
	\begin{itemize}
	\item LSI. Librería colaborativa desarrollada en el \ac{LSI} en el que se encuentran los componentes ya utilizados.
...
Los componentes y la \ac{PCB} fueron adquiridos por separado, por lo que tuvieron que ser soldados \textit{a posteriori}. La estacíón de soldadura JBC AM6000 \cite{jbc} fue usada con este propósito, proporcionando puntas de soldadura de entre 1 y 4 mm de diámetro y otras herramientas prácticas, como pinzas calientes o soldadora por aire caliente.

Debido a la presencia de compontentes de tamaño reducido, se hizo necesario el uso de un microscopio con el objeto de realizar soldaduras precisas. Es por ello que en el puesto de soldadura también contábamos con un microscopio Bausch \& Lomb StereoZoom 4, así como de unas mordazas que permitían mantener fija la placa y unas pinzas adecuadas para poder colocar los componentes \ac{SMD} en su posición a la hora de realizar la soldadura.