...
En primer lugar probamos el \textbf{\ac{ADC}}, la cual consistió en formar un divisor de tensión por medio de resistencias conectadas a $V_{CC}$ y a GND, e introducir la tensión en distintos puntos en el \ac{ADC}, de forma que comprobáramos que la palabra obtenida era la que correspondía.
...
En cuando a los actuadores, comenzamos evaluando el \textbf{Emisor Infrarrojo}. Decidimos implementar el protocolo del aire acondicionado, debido a que la placa dispone de sensor de temperatura y puede conocer, por tanto, el valor de la misma en tiempo real. La temporalización de esta trama se corresponde con la de la figura \ref{software:fig:tramair}. 
