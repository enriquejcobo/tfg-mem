...
Los bytes que forman las tramas fueron decodificados por medio de la inspección de la trama enviada por el mando original, usando el receptor y presentando dicha trama en el osciloscopio. La figura \ref{pruebas:fig:tramaaa} muestra en detalle la trama recibida. A partir del análisis de varias tramas en las que se modificaba algún parámetro (conocido), procedimos a identificar la posición de los mismos dentro de la trama, mediante el uso de una hoja de cálculo. 
