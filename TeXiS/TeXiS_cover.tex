...
\vspace{2cm}
%\begin{flushright}
\hspace{4.5cm}Madrid, a \hspace{1cm} de \hspace{4.5cm} de 
%\end{flushright}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{Imagenes/Bitmap/Otras/qrmemoria}
\end{center}

\begin{small}
\begin{center}
Versión online. \emph{\url{https://www.dropbox.com/s/ct2cdgvdn0c5lze/tfg\%20Enrique\%20Cobo.pdf}}.
\end{center}
\end{small}
...
\begin{center}
\vspace*{1cm}
Todos los ficheros usados para hacer este documento son accesibles públicamente en el siguiente repositorio: \emph{\url{https://github.com/enriquejcobo/tfg-mem}}.
\end{center}
\end{small}
