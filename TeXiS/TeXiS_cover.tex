...
\begin{center}
\vspace*{1cm}
Todos los ficheros usados para hacer este documento son accesibles públicamente en el siguiente repositorio: \emph{\url{https://github.com/agus-xyz/cNGD-mem}}.
\end{center}
\end{small}
